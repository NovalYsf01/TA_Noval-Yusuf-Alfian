...
final class EmergencyReportController extends ApiController
{
    public function index(
        IndexEmergencyReportRequest $request
    ): JsonResponse {
        /** @var User $user */
        $user = $request->user();
    ...
    public function store(
        ...
        $report =
            EmergencyReport::query()
                ->create([
                    ...
                    /*
                     * Status ditetapkan eksplisit
                     * agar object Eloquent langsung
                     * memiliki nilai WAITING.
                     */
                    'status' =>
        ...
        /*
         * Refresh memastikan nilai database,
         * casts dan relasi menggunakan data
         * terbaru sebelum event dikirim.
         */
        $report->refresh();

        EmergencyReportCreated::dispatch(
            $report
        );

        return $this->resource(
            new EmergencyReportResource(
                $report
            ),
